...
<body>
	<div class="container-fluid">
		...
		<div class="container main_lichsu">
			<div class="header_lichsu">
				...
				<h3 style="text-transform: uppercase;"><b>KỲ THI {{$ct->tenky}}</b></h3>
					...
					<div class="information"><b>Đề: {{$ct->trangthai}} | <b>Môn: {{$ct->tenmh}}</b> | <b>Số câu: {{count($ctdethi2)}} câu</b> | <b>Thời gian thi: {{$ct->thoigianthi}} phút</b></b></div>
				@endforeach
			</div>
		...
		<div class="content1">
			...
			@elseif($dapanchon[$key] == 'A' && $dapandung[$key] != 'A')
			...
			@elseif($dapanchon[$key] == 'B' && $dapandung[$key] != 'B')
				<label style="background: red"  class="option">
			...
			@elseif($dapanchon[$key] == 'C' && $dapandung[$key] != 'C')
				<label style="background: red"  class="option">
			...
			@endif
				@if($dapandung[$key] == 'D') 
				<label  style="background: #00FF5A" class="option"><input type="radio" name="option"  value="D"><span id="opt"> D. {!!$ct->d!!}</span></label>
			
			@elseif($dapanchon[$key] == 'D' && $dapandung[$key] != 'D')
				<label  style="background: red"  class="option">
