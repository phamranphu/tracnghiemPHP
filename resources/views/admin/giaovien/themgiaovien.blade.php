...
@section('main')
		 <div class="design_cauhoi">
            ...
            <div class="panel panel-default khungbang">
					...
					@endif
                    <!-- <div class="datatable"> -->
        		<form action="/postgv" method="POST" enctype="multipart/form-data">
        			<input type="hidden" name="_token" value="{{csrf_token()}}">
					<table class="table">
						
						<tr class="tbl">
							<td class="style_row"><i class="fa fa-edit"></i> &nbsp; &nbsp;Tên Giáo Viên</td>
							<td><input type="text" class="from-control nhaploai" placeholder="  Nhập tên giáo viên" name="tengiaovien" />
						...
						<tr>
							<td class="style_row tbl-row" colspan="2" >
								...
								<button  style="border-radius: 5px; border: 0px;" type="reset" class="btn  btnxoach" ><a href="admin/giaovien/dsgiaovien" style="color: #FFF">Quay lại</a></button>
