...
@section('body')	
			...
			<div class="row anhbanner" style="width: 1550px">
				...
				<div class="col-md-12 banner">
					<h3 class="dream">THEO ĐUỔI ĐAM MÊ</h3>
					<div class="up">
						<h2 class="online">CHẮP CÁNH ƯỚC MƠ</h2>
					<h2 class="training">ÔN LUYỆN</h2>
					</div>
					<p class="canbtn">
						<a href="tintuc"><span class="view">XEM THÊM</span></a>
						<a href="thithptquocgia"><span class="thamgia">THAM GIA THI</span></a>
					</p>
				</div>
			</div>
			...
			<div class="col-md-4">
				<div class="card middle">
					<div class="front anhfb1">
						...
						<p class="tenthisinh">Trần Thị Tình</p>
